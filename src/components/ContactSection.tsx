              ...
              <div className="p-8">
                ...
                <div className="mt-10 pt-8 border-t border-gray-200">
                  ...
                  <div className="flex space-x-4">
                    ...
                    <a href="https://t.me/+998770884977" target="_blank" rel="noopener noreferrer" className="bg-gray-100 hover:bg-[#fb8500] hover:text-white transition-all duration-300 p-3 rounded-full">
                      <svg className="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="https://www.instagram.com/fablab.cfyi" target="_blank" rel="noopener noreferrer" className="bg-gray-100 hover:bg-[#fb8500] hover:text-white transition-all duration-300 p-3 rounded-full">
                      <svg className="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="https://www.facebook.com/centerforyouthinitiatives" target="_blank" rel="noopener noreferrer" className="bg-gray-100 hover:bg-[#fb8500] hover:text-white transition-all duration-300 p-3 rounded-full">
                      <svg className="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path>
                      </svg>
                    </a>
                    <a href="https://www.youtube.com/@CenterforYouthInitiatives" target="_blank" rel="noopener noreferrer" className="bg-gray-100 hover:bg-[#fb8500] hover:text-white transition-all duration-300 p-3 rounded-full">
                      <svg className="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
